"""autogenerated by genpy from staubli_tx60/SetJointTrajectoryAction.msg. Do not edit."""
import sys
...
class SetJointTrajectoryAction(genpy.Message):
  _md5sum = "8cf90a0106bd9e9fb426581eb20669ec"
  _type = "staubli_tx60/SetJointTrajectoryAction"
...
"""
  ...
  _slot_types = ['staubli_tx60/SetJointTrajectoryActionGoal','staubli_tx60/SetJointTrajectoryActionResult','staubli_tx60/SetJointTrajectoryActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SetJointTrajectoryAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = staubli_tx60.msg.SetJointTrajectoryActionGoal()
      if self.action_result is None:
        self.action_result = staubli_tx60.msg.SetJointTrajectoryActionResult()
      if self.action_feedback is None:
        self.action_feedback = staubli_tx60.msg.SetJointTrajectoryActionFeedback()
    else:
      self.action_goal = staubli_tx60.msg.SetJointTrajectoryActionGoal()
      self.action_result = staubli_tx60.msg.SetJointTrajectoryActionResult()
      self.action_feedback = staubli_tx60.msg.SetJointTrajectoryActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_goal.goal.jointTrajectory)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.jointTrajectory:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.jointTrajectory = []
      for i in range(0, length):
        ...
        self.action_goal.goal.jointTrajectory.append(val1)
      _x = self
      start = end
      end += 12

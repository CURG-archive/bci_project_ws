...
(cl:defmethod cl:initialize-instance :after ((m <LocationInfo-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LocationInfo-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name moveit_trajectory_planner-srv:<LocationInfo-request> is deprecated: use moveit_trajectory_planner-srv:LocationInfo-request instead.")))

(cl:ensure-generic-function 'grasp-val :lambda-list '(m))
(cl:defmethod grasp-val ((m <LocationInfo-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader moveit_trajectory_planner-srv:grasp-val is deprecated.  Use moveit_trajectory_planner-srv:grasp instead.")
  (grasp m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LocationInfo-request>)))
  ...
  "moveit_trajectory_planner/LocationInfoRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LocationInfo-request)))
  "Returns string type for a service object of type 'LocationInfo-request"
  "moveit_trajectory_planner/LocationInfoRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <LocationInfo-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LocationInfo-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name moveit_trajectory_planner-srv:<LocationInfo-response> is deprecated: use moveit_trajectory_planner-srv:LocationInfo-response instead.")))

(cl:ensure-generic-function 'isPossible-val :lambda-list '(m))
(cl:defmethod isPossible-val ((m <LocationInfo-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader moveit_trajectory_planner-srv:isPossible-val is deprecated.  Use moveit_trajectory_planner-srv:isPossible instead.")
  (isPossible m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LocationInfo-response>)))
  ...
  "moveit_trajectory_planner/LocationInfoResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LocationInfo-response)))
  "Returns string type for a service object of type 'LocationInfo-response"
  "moveit_trajectory_planner/LocationInfoResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LocationInfo)))
  ...
  "moveit_trajectory_planner/LocationInfo")
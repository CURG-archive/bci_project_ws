...
if("TRUE" STREQUAL "TRUE")
  set(openni_launch_SOURCE_PREFIX /home/mpcadosch/Dev/bci_ros/bci_project_ws/src/openni_launch)
  set(openni_launch_DEVEL_PREFIX /home/mpcadosch/Dev/bci_ros/bci_project_ws/devel)
  ...
  set(openni_launch_INSTALL_PREFIX /home/mpcadosch/Dev/bci_ros/bci_project_ws/install)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'openni_launch' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mpcadosch/Dev/bci_ros/bci_project_ws/src/openni_launch/${idir}'.  Ask the maintainer 'Julius Kammerl <jkammerl@willowgarage.com>, Jon Binney <jbinney@willowgarage.com>' to fix it.")
    endif()

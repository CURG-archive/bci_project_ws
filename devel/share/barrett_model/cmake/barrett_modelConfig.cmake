...
if("TRUE" STREQUAL "TRUE")
  set(barrett_model_SOURCE_PREFIX /home/mpcadosch/Dev/bci_ros/bci_project_ws/src/barrett_model)
  set(barrett_model_DEVEL_PREFIX /home/mpcadosch/Dev/bci_ros/bci_project_ws/devel)
  ...
  set(barrett_model_INSTALL_PREFIX /home/mpcadosch/Dev/bci_ros/bci_project_ws/install)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'barrett_model' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mpcadosch/Dev/bci_ros/bci_project_ws/src/barrett_model/${idir}'.  Ask the maintainer 'Jonathan Bohren <jbo@jhu.edu>' to fix it.")
    endif()

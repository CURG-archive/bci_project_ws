...
cd "/home/mpcadosch/Dev/bci_ros/bci_project_ws/src/trajectory_planner"
...
/usr/bin/env \
    ...
    build --build-base "/home/mpcadosch/Dev/bci_ros/bci_project_ws/build/trajectory_planner" \
    install \
    $DESTDIR_ARG \
